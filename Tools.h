...
// разделить файл на спп и х
// тут будут функции вне класса типо вспомогательных и генерации мапы?
// их бы желательно наверное потом в неймспейс объединить(кроме маппы ай гесс), но мне сейчас впадлу(
// думаю от логики с непосредственными фигурами в формировании маппы отказаться, создать массив с рисованными стенами проще кажется

// в маппе использую array тк он в отличие от статического не распадается на указатели и еще у него размер не меняется
//по сути это аналог статического, но на уровне синтаксическом он проще в использовании
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
